...
|8.  София С.А.     | 6. Защита данных в распределенных системах             |
|9.  София С.М.     | 8.4. Развитие систем распознавания вторжений           |
|10. Тимур Д.       | 5.1 - 5.4 Механизмы, поддерживающие выскую готовность  |
